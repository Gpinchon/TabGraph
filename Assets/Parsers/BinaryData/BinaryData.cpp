...
std::shared_ptr<Assets::Asset> ParseBinaryData(const std::shared_ptr<Assets::Asset>&);
...
std::shared_ptr<Assets::Asset> ParseBinaryData(const std::shared_ptr<Assets::Asset>& asset)
{
